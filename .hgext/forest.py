...
from mercurial.hgweb import protocol as mylocalprotocol
mylocalprotocol.do_capabilities = _httpserver_do_capabilities
...
mylocalprotocol.forests = _httpserver_do_forests
mylocalprotocol.__all__.append('forests')
